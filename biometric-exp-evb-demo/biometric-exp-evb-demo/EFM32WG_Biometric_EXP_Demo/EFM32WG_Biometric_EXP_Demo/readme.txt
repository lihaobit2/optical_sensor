...
the LCD display on the EFM32WG_STK3800 kit. In addition, it
demonstrates the use of Silabs I2C based sensors on the expansion board
header.

You must have a Silabs Biometric Sensor add-on board to make use of this demo.
...
Board:  Silicon Labs EFM32WG-STK3800 Development Kit and Sensor Add-on board
