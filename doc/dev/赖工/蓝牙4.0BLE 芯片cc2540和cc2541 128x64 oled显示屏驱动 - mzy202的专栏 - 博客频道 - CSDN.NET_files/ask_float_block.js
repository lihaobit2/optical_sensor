(function(){
    $(function(){
        ...
        //var prot = window.location.protocol;
        //判断是否首次点击提问按钮
        var check_accept_rules_url = prot + "//test.ask.csdn.net:3000/users/check_accept_rules.js";//"//ask.csdn.net/users/check_accept_rules.js";
        //提问时，标题录入框的自动完成
        var ask_topic_autocomplete_url = prot + "//test.ask.csdn.net:3000/questions/autocomplete.js";
        //提问时，光标离开标题后的推荐标签
        ...
        //提问时，发布问题的地址
        var create_question_proxy = prot + "//test.ask.csdn.net:3000/proxy.html";
        var create_question_url = prot + "//test.ask.csdn.net:3000/questions/create_question.json";
        //验证C币
        var valid_coin=   prot + "//test.ask.csdn.net:3000/users/get_scores.js";
        //问题链接跳转
        var ask_detail_url =  prot + "//test.ask.csdn.net:3000/questions/";
        var ajaxProxyCaches = {};
