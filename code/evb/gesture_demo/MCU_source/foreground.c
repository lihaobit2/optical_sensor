...
#define MISC_OPTIONS_0 (misc_options&0x01)  // Defines whether or not to 
...
void Process_INT()
{
    ...
    for( device=0; device < 2; device++ )
    {
        ...
        {
            error  = i2c_smbus_read_i2c_block_idata( si114x_handle, 0x21, 13, Data_Buffer );
            error += i2c_smbus_write_byte_data( si114x_handle, 0x21, 0xff ); 
